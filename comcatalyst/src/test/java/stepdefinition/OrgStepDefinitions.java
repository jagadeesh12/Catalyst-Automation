...
/*
    ...
    public void user_creates_Chef_Server() throws Throwable {
        ...
        given()
                ...
                .header("x-catalyst-auth", token)
                .multiPart("userpemfile", new File("/var/lib/jenkins/jobs/Catalyst_API_Automation/workspace/comcatalyst/src/Filesupload/jagadeesh12.pem"))
                .multiPart("kniferbfile", new File("/var/lib/jenkins/jobs/Catalyst_API_Automation/workspace/comcatalyst/src/Filesupload/knife.rb"))
