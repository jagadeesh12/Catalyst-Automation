...
/*
    ...
    public void user_creates_Chef_Server() throws Throwable {
        ...
        given()
                ...
                .header("x-catalyst-auth", token)
                .multiPart("userpemfile", new File("/home/jagadeesh/CatalystAPIAutomation/comcatalyst/src/Filesupload/jagadeesh12.pem"))
                .multiPart("kniferbfile", new File("/home/jagadeesh/CatalystAPIAutomation/comcatalyst/src/Filesupload/knife.rb"))
